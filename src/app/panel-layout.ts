    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">World Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}${!location.hostname.endsWith('worldmonitor.app') ? '<button class="agent-back-btn" id="agentBackBtn" title="Switch agent">&#9664;</button>' : ''}
        ...
        <div class="header-right">
          <a href="https://en.newscore.fr" target="_blank" rel="noopener" style="display:flex;align-items:center;gap:6px;text-decoration:none;margin-right:8px;">
            <span style="color:#3377fa;font-weight:800;font-size:0.85rem;letter-spacing:-0.3px;">newscore</span>
          </a>
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <a class="mobile-menu-item" href="https://en.newscore.fr" target="_blank" rel="noopener">
          <span class="mobile-menu-item-icon" style="color:#3377fa;font-weight:700;">NC</span>
          <span class="mobile-menu-item-label">NewsCore</span>
        </a>
        <div class="mobile-menu-divider"></div>
